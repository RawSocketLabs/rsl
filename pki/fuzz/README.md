...
| `certificate_parse` | Raw and structured mutations of published NIST PKITS certificates | parsing never panics; accepted certificates preserve exact certificate and `TBSCertificate` bytes; fields shared with `x509-parser` agree |
