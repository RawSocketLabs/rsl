//! Project Wycheproof `chacha20_poly1305_test.json`, copied mechanically.
//!
//! Provenance: `tests/vectors/chacha20-poly1305/README.md`. Groups with a nonce size other than
//! 96 bits are included so the typed nonce boundary is exercised.
