...
use rsl_crypto::agreement::ecdh_p384::EcdhP384PublicKey;
...
pub(crate) fn public_key(x: &str, y: &str) -> EcdhP384PublicKey {
    EcdhP384PublicKey::from_bytes(uncompressed(x, y)).expect("published point is on the curve")
}
